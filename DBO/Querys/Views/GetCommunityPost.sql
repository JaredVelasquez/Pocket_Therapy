...
WHERE sys.schemas.name = N'dbo'
    AND sys.views.name = N'GetCommunityPost'
)
...
AS
    SELECT us.user_id  'UserId', us.photoUrl  'Photo', us.username  'Username', po.post_id 'PostId', ha.name 'Hashtag', po.contentPost 'Content', co.comentcnt'Coment', co.likeacnt'Like'
